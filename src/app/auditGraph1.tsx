...
//         {/* LABELS */}
//         <text x="200" y="50" textAnchor="middle" fill="#00e676">
//           Up {upPct.toFixed(1)}%
//         </text>
//         <text x="200" y="370" textAnchor="middle" fill="#ff5252">
...
export default function AuditRatioGraph({ token }: { token: string }) {
  ...
  useEffect(() => {
    ...
    const fetchAuditData = async () => {
      ...
      const transactions = json.data.transaction as {
        type: "up" | "down" | "xp";
        amount: number;
      }[];
  ...
  if (loading || !data) return <p>Loading audit data…</p>;
